...
describe('Test Utilities', () => {
  it('renderWithRouter should render component with router', () => {
    renderWithRouter(React.createElement(TestComponent, null, 'Test Content'));
    expect(screen.getByTestId('test-component')).toBeInTheDocument();
    expect(screen.getByText('Test Content')).toBeInTheDocument();
  });

  it('mockApiResponse should resolve with data after delay', async () => {
  ...
  it('mockApiError should reject with error after delay', async () => {
...
describe('Form Testing Utilities', () => {
  it('fillFormField should fill form fields', () => {
    render(
      React.createElement(
        'form',
        null,
        React.createElement('input', { 'data-testid': 'test-field' })
      )
    );

    const field = fillFormField('test-field', 'test value');
    expect(field.value).toBe('test value');
  });

  it('createMockApiService should create proper mock', () => {
